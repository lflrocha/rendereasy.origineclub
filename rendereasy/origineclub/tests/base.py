...
def setup_product():
    ...
    import rendereasy.origineclub
    zcml.load_config('configure.zcml', rendereasy.origineclub)
    ...
    ztc.installPackage('rendereasy.origineclub')
...
setup_product()
ptc.setupPloneSite(products=['rendereasy.origineclub'])
